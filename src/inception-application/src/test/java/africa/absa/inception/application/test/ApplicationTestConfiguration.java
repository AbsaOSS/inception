...
package africa.absa.inception.application.test;
 ...
 */
@Configuration
@ComponentScan(basePackages = {"africa.absa.inception.application.test"})
@EnableJpaRepositories(
    entityManagerFactoryRef = "applicationTestEntityManagerFactory",
    basePackages = {"africa.absa.inception.application.test"})
public class ApplicationTestConfiguration {
  ...
  public LocalContainerEntityManagerFactoryBean applicationTestEntityManagerFactory(
    ...
    return JpaUtil.createEntityManager(
        ...
        "africa.absa.inception.application.test");
  }
}
