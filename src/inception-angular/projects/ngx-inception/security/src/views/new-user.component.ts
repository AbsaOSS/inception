...
export class NewUserComponent extends AdminContainerView implements AfterViewInit {
  ...
  constructor(private router: Router, private activatedRoute: ActivatedRoute, private securityService: SecurityService,
    ...
    this.emailFormControl = new FormControl('', [Validators.maxLength(100), Validators.pattern(// eslint:disable-next-line:max-line-length
    ...
    // eslint:disable-next-line:max-line-length
    this.mobileNumberFormControl = new FormControl('', [Validators.maxLength(100), Validators.pattern(// eslint:disable-next-line:max-line-length
