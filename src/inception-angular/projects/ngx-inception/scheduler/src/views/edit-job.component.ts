...
export class EditJobComponent extends AdminContainerView implements AfterViewInit {
  ...
  constructor(private router: Router, private activatedRoute: ActivatedRoute,
    ...
    this.schedulingPatternFormControl = // eslint:disable-next-line:max-line-length
      new FormControl('0 * * * *', [Validators.required, Validators.maxLength(100), Validators.pattern(// eslint:disable-next-line:max-line-length
